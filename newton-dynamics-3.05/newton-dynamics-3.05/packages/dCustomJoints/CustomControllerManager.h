...
class CustomControllerManager: public CustomControllerBase  
{
	...
	void* GetFirstControllerNode() const {return m_controllerList.GetFirst();}
	void* GetNextControllerNode(void* const node) const {return ((CustomControllerList::dListNode*)node)->GetNext();}
	CustomController* GetControllerFromNode(void* const node) const {return &((CustomControllerList::dListNode*)node)->GetInfo();}
