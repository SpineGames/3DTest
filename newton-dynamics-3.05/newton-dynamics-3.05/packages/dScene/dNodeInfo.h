...
class dNodeInfo: public dClassInfo, public dVariableList
{
	...
	virtual void DrawWireFrame(dSceneRender* const render, dScene* const scene, dScene::dTreeNode* const myNode) const{_ASSERTE (0);}
	virtual void DrawFlatShaded(dSceneRender* const render, dScene* const scene, dScene::dTreeNode* const myNode) const{_ASSERTE (0);}
