...
void __cdecl free(_Inout_opt_ void * _Memory)
{
	::free (_Memory);
}
...
void * __cdecl calloc(_In_ size_t _NumOfElements, _In_ size_t _SizeOfElements)
{
	void* const ptr = malloc (_NumOfElements * _SizeOfElements);
