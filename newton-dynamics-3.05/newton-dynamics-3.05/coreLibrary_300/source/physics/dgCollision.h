...
class dgCollision
{
	...
	//virtual bool PolygonOBBTest (const dgFloat32* const polygon, dgInt32 strideInBytes, const dgInt32* const indexArray, dgInt32 indexCount, const dgVector& boxP0, const dgVector& boxP1) const {_ASSERTE (0); return true;}  
	virtual bool PolygonOBBTest (const dgFloat32* const polygon, dgInt32 strideInBytes, const dgInt32* const indexArray, dgInt32 indexCount, const dgPolygonMeshDesc& descInfo) const {_ASSERTE (0); return true;}  
